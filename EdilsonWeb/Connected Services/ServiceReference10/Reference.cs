...
namespace EdilsonWeb.ServiceReference10 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference10.IServicexD")]
    public interface IServicexD {
        ...
        void InsertarDatoAlFinal(string nombre, string apellido, string email, string sexo, int codeCiudad, string requerimiento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicexD/InsertarDatoAlFinal", ReplyAction="http://tempuri.org/IServicexD/InsertarDatoAlFinalResponse")]
        System.Threading.Tasks.Task InsertarDatoAlFinalAsync(string nombre, string apellido, string email, string sexo, int codeCiudad, string requerimiento);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicexDChannel : EdilsonWeb.ServiceReference10.IServicexD, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicexDClient : System.ServiceModel.ClientBase<EdilsonWeb.ServiceReference10.IServicexD>, EdilsonWeb.ServiceReference10.IServicexD {
        ...
        public void InsertarDatoAlFinal(string nombre, string apellido, string email, string sexo, int codeCiudad, string requerimiento) {
            base.Channel.InsertarDatoAlFinal(nombre, apellido, email, sexo, codeCiudad, requerimiento);
        }
        
        public System.Threading.Tasks.Task InsertarDatoAlFinalAsync(string nombre, string apellido, string email, string sexo, int codeCiudad, string requerimiento) {
            return base.Channel.InsertarDatoAlFinalAsync(nombre, apellido, email, sexo, codeCiudad, requerimiento);
        }
    }
}
